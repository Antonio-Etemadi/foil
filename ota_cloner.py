...
class OTA:
    def __init__(self, url,directory="/",json_path="/",json_name="name_and_sha.json",ota_cloner_name="ota_cloner.py",log_name="ota.log",console_log_level="INFO",file_log_level="INFO"):
